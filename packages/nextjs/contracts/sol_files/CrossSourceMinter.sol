...
contract CrossSourceMinter {
    ...
    constructor(address destMinterAddress) {
        ...
        // from Fuji
        address routerAddressFuji = 0x774db69637129b2C5c4A5dF9E940dCAfD46f423B; //0xF694E193200268f9a4868e4Aa017A0118C9a8177;
        router = IRouterClient(routerAddressFuji);
        linkToken = LinkTokenInterface(0x73aFBB4566Dd91D4D2ebd960949e95E094d6635C); //0x0b9d5D9136855f6FEc3c0993feE6E9CE8a297846);
